...
export class QuoteComponent implements OnInit {
  ...
  quotes: Quote[] = [
    ...
    // tslint:disable-next-line:max-line-length
    new Quote(3, 'Find your Purpose', 'Find something more important than you are, and dedicate your life to it!', 'Dan Dennett', 'Maria Popova', 0, 0, new Date(2010, 12, 1)),

    // tslint:disable-next-line:max-line-length
    new Quote(4, 'Life\'s Dance', 'I myself am a firm believer in the power of curiosity and choice as the engine of fulfillment, but precisely how you arrive at your true calling is an intricate and highly individual dance of discovery', 'Maria Popova', 'RK', 0, 0, new Date(2016, 3, 16)),
